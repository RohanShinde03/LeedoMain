package com.tribeappsoft.leedo.salesPerson.salesHead.callLogStats.adapter;
...
public class FilterCompletedCallsAdapter extends RecyclerView.Adapter<FilterCompletedCallsAdapter.MyHolder> {
    private static final String TAG ="FilterCompCallsAdapter" ;
    ...
    public FilterCompletedCallsAdapter(Activity context, ArrayList<ScheduledCallsModel> modelArrayList, boolean isFromSchedule) {
    ...
    public void onBindViewHolder(@NonNull MyHolder holder, int position) {
        ...
        if(model.getSchedule_status_id()==3)
        {
            holder.tv_ScheduledStatus.setText(R.string.completed);
        }
        ...
        //Set Lead Details
        if (model.getCallDetailsTitleModelArrayList()!=null && model.getCallDetailsTitleModelArrayList().size()>0)
        {

            holder.ll_leadDetailsMain.setVisibility(View.VISIBLE);
            holder.ll_ownAddLeadDetailsSchedule.removeAllViews();
            for (int i =0 ; i< model.getCallDetailsTitleModelArrayList().size(); i++)
            {
                //Log.e("ll_HomeFeed_own_", "onBindViewHolder: "+myModel.getDetailsTitleModelArrayList().size());
                ...
                final AppCompatTextView tv_leads_tag_details_title_text = rowView_sub.findViewById(R.id.tv_itemLeadDetails_title);
                final LinearLayoutCompat ll_addDetails = rowView_sub.findViewById(R.id.ll_itemLeadDetails_addDetails);
                tv_leads_tag_details_title_text.setText( model.getCallDetailsTitleModelArrayList().get(i).getLead_details_title());
                ll_addDetails.removeAllViews();
                ArrayList<LeadDetailsModel> detailsModelArrayList =  model.getCallDetailsTitleModelArrayList().get(i).getLeadDetailsModels();
                if (detailsModelArrayList!=null && detailsModelArrayList.size()>0)
                {
                    for (int j=0; j<detailsModelArrayList.size(); j++)
                    {
                ...
                holder.ll_ownAddLeadDetailsSchedule.addView(rowView_sub);
            }

        } else
        {
            holder.ll_ownAddLeadDetailsSchedule.setVisibility(View.GONE);
            holder.view_callScheduleMain.setVisibility(View.GONE);
        }
...
/*
    ...
    static class MyHolder extends RecyclerView.ViewHolder {
        ...
        @BindView(R.id.ll_CallList_ownAddLeadDetailsSchedule)  LinearLayoutCompat ll_ownAddLeadDetailsSchedule;
        ...
        @BindView(R.id.ll_schedule_on) LinearLayoutCompat ll_schedule_on;
        @BindView(R.id.ll_schedule_button) LinearLayoutCompat ll_schedule_button;
        ...
        //@BindView(R.id.tv_CallList_CallStatus) AppCompatTextView tv_CallStatus;
