package com.tribeappsoft.leedo.salesPerson.salesHead.siteVisits.model;
...
public class SiteVisitListModel implements Serializable, Parcelable {
    ...
    public SiteVisitListModel() {}
    protected SiteVisitListModel(Parcel in) {
        lead_id = in.readInt();
    ...
    public static Creator<SiteVisitListModel> getCREATOR() {
        return CREATOR;
    }
    ...
    public static final Creator<SiteVisitListModel> CREATOR = new Creator<SiteVisitListModel>() {
        @Override
        public SiteVisitListModel createFromParcel(Parcel in) {
            return new SiteVisitListModel(in);
        }

        @Override
        public SiteVisitListModel[] newArray(int size) {
            return new SiteVisitListModel[size];
        }
    };
