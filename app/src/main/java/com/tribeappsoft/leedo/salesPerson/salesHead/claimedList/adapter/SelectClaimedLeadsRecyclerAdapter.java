package com.tribeappsoft.leedo.salesPerson.salesHead.claimedList.adapter;
...
import com.tribeappsoft.leedo.salesPerson.salesHead.claimedList.ClaimedLeads_Activity;
...
public class SelectClaimedLeadsRecyclerAdapter extends RecyclerView.Adapter<SelectClaimedLeadsRecyclerAdapter.MyHolder> {
    public ClaimedLeads_Activity context;
    public ArrayList<ClaimedLeadsModel> itemArrayList,multiSelect_list;
    private ArrayList<Integer> leadIdArrayList;
    private final Animations anim;
    private int lastPosition = -1;
    // private int count=0;

    public SelectClaimedLeadsRecyclerAdapter(ClaimedLeads_Activity context, ArrayList<ClaimedLeadsModel> modelArrayList, ArrayList<ClaimedLeadsModel> multiSelect_list) {
    ...
    public MyHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_layout_claimed_lead_list, parent,false);
    ...
    public void onBindViewHolder(@NonNull MyHolder holder, int position) {
        ...
        final ClaimedLeadsModel model= itemArrayList.get(position);
     ...
     //   holder.tv_cp_executive_name.setText(model.getCp_executive_name() != null && !model.getCp_executive_name().trim().isEmpty()? model.getCp_executive_name() :"--");
        ...
        if(multiSelect_list.contains(itemArrayList.get(position))) {
            ...
            holder.ll_claimedLeads_main.setBackgroundColor(ContextCompat.getColor(context, R.color.color_other_feed_card_background));
        }
        else {
            holder.ll_cardMain.setBackgroundColor(ContextCompat.getColor(context, R.color.main_white));
            holder.ll_claimedLeads_main.setBackgroundColor(ContextCompat.getColor(context, R.color.black_full_transparent));
        }
...
/*
    ...
    static class MyHolder extends RecyclerView.ViewHolder {
        ...
        @BindView(R.id.iv_claimedLeads_TagIcon) AppCompatImageView iv_ownTagIcon;
        @BindView(R.id.iv_claimedLeads_LeadWhatsApp) AppCompatImageView iv_ownLeadWhatsApp;
        @BindView(R.id.iv_claimedLeads_LeadCall) AppCompatImageView iv_ownLeadCall;
        @BindView(R.id.iv_claimedLeads_ownReminderIcon) AppCompatImageView iv_ownReminderIcon;
        @BindView(R.id.iv_claimedLeads_leadDetails_ec) AppCompatImageView iv_leadDetails_ec;
        @BindView(R.id.ll_claimedLeads_leadDetailsMain) LinearLayoutCompat ll_leadDetailsMain;
        @BindView(R.id.ll_claimedLeads_ownAddLeadDetails)  LinearLayoutCompat ll_ownAddLeadDetails;
        @BindView(R.id.ll_claimedLeads_ownViewLeadDetails) LinearLayoutCompat ll_ownViewLeadDetails;
        @BindView(R.id.ll_cardMain) LinearLayoutCompat ll_cardMain;
        @BindView(R.id.cv_itemClaimedLeads_main) MaterialCardView cv_main;
        @BindView(R.id.ll_claimedLeads_main) LinearLayoutCompat ll_claimedLeads_main;
        @BindView(R.id.ll_claimedLeads_LeadType) LinearLayoutCompat ll_LeadType;
        @BindView(R.id.tv_claimedLeadsTag) AppCompatTextView tv_LeadsOwnTag;
        @BindView(R.id.tv_claimedLeads_SalesPersonName) AppCompatTextView tv_SalesPersonName;
        @BindView(R.id.tv_claimedLeadsCuIdNumber) AppCompatTextView tv_CuIdNumber;
        @BindView(R.id.tv_claimedLeads_ownDate) AppCompatTextView tv_ownDate;
        @BindView(R.id.tv_claimedLeads_LeadName) AppCompatTextView tv_LeadName;
        @BindView(R.id.tv_claimedLeads_LeadMobile) AppCompatTextView tv_LeadMobile;
        @BindView(R.id.tv_claimedLeads_ProjectName) AppCompatTextView tv_ProjectName;
        @BindView(R.id.tv_ClaimedLeads_FirstCallMade) AppCompatTextView tv_FirstCallMade;
        @BindView(R.id.tv_ClaimedLeads_NoOfCallMade) AppCompatTextView tv_NoOfCallMade;
        @BindView(R.id.tv_claimedLeads_cpName) AppCompatTextView tv_claimedLeads_cpName;
        @BindView(R.id.tv_cp_executive_name) AppCompatTextView tv_cp_executive_name;
        @BindView(R.id.tv_ClaimedLeads_AvgCallDuration) AppCompatTextView tv_AvgCallDuration;
