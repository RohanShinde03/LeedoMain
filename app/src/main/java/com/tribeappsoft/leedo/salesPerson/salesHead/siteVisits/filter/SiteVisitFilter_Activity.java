package com.tribeappsoft.leedo.salesPerson.salesHead.siteVisits.filter;
...
public class SiteVisitFilter_Activity extends AppCompatActivity {
    ...
    private String TAG = "FilterMore_Activity",api_token = "", selectedProjectName="", sendFromDate = null, sendToDate = null,selectedSalesPersonsName="";
    private int filterCount_siteVisit =0;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_site_visit_filter_);

        ButterKnife.bind(this);
        context= SiteVisitFilter_Activity.this;
            ...
            acTv_selectProject.setOnItemClickListener((AdapterView<?> parent, View view, int position, long id) ->
            {
                ...
                for (ProjectModel pojo : itemArrayList)
                {
                    if (pojo.getProject_name().equals(itemName))
                    {
                        ...
                        filterCount_siteVisit = sales_person_id == 0 && (sendFromDate ==null && sendToDate ==null) ? 1 : sales_person_id > 0 && (sendFromDate != null && sendToDate !=null) ? 3 : 2;
                        Log.e(TAG, "setAdapterForProjectName: "+ filterCount_siteVisit);
        ...
        datePickerDialog = new DatePickerDialog(Objects.requireNonNull(context),
                (view, year, monthOfYear, dayOfMonth) -> {
                    ...
                    if(sendFromDate!=null &sendToDate!=null) {
                        ...
                        filterCount_siteVisit = selectedProjectId == -1 && sales_person_id == 0 ? 1 : selectedProjectId >=0  && sales_person_id > 0 ? 3 : 2;
                    }
        ...
        datePickerDialog = new DatePickerDialog(Objects.requireNonNull(context),
                (view, year, monthOfYear, dayOfMonth) -> {
                    ...
                    if(sendFromDate!=null &sendToDate!=null) {
                        ...
                        filterCount_siteVisit = selectedProjectId == -1 && sales_person_id == 0 ? 1 : selectedProjectId >=0  && sales_person_id > 0 ? 3 : 2;
                        Log.e(TAG, "selectVisitPrefToDate: "+ filterCount_siteVisit);
                ...
                acTv__select_SalesPerson.setOnItemClickListener((AdapterView<?> parent, View view, int position, long id) ->
                {
                    ...
                    for (SalesExecutiveModel pojo : salesExecutiveModelArrayList)
                    {
                        if (pojo.getFull_name().equals(itemName))
                        {
                            ...
                            filterCount_siteVisit = selectedProjectId == -1 &&  (sendFromDate ==null && sendToDate ==null) ? 1 : selectedProjectId >= 0 && (sendFromDate != null && sendToDate !=null) ?  3 :  2;

                            Log.e(TAG, "setAdapterSalesPersonsNames: "+ filterCount_siteVisit);
        ...
        if (selectedProjectId==-1  && sales_person_id==0  && sendFromDate ==null && sendToDate ==  null) new Helper().showCustomToast(context, "Please select at least one filter type!");
           ...
           /* if (selectedProjectId!=-1)
            ...
            if (sharedPreferences!=null) {
                ...
                editor.putInt("filterCount_siteVisit", filterCount_siteVisit);
