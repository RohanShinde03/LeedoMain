...
import com.tribeappsoft.leedo.salesPerson.salesHead.siteVisits.SelectSalesPersonsActivity;
...
public class SelectedGhpLeadsReAssign_Activity extends AppCompatActivity {

    @BindView(R.id.cl_GhpLeadsReAssign)
    CoordinatorLayout parent;
    @BindView(R.id.ll_GhpLeadsReAssign_main)
    LinearLayoutCompat ll_main;

    @BindView(R.id.rdoGrp_GhpLeadsReAssign)
    RadioGroup rdoGrp_GhpLeadsReAssign;
    @BindView(R.id.mRb_GhpLeadsReAssign_manual)
    MaterialRadioButton mRb_manual;
    @BindView(R.id.mRb_GhpLeadsReAssign_auto) MaterialRadioButton mRb_auto;

    @BindView(R.id.ll_GhpLeadsReAssign_auto) LinearLayoutCompat ll_auto;
    @BindView(R.id.acTv_GhpLeadsReAssign_selectAutoLogicType)
    AutoCompleteTextView acTv_selectAutoLogicType;
    @BindView(R.id.mTv_GhpLeadsReAssign_selectMultiSalesPerson)
    MaterialTextView mTv_selectMultiSalesPerson;

    @BindView(R.id.ll_GhpLeadsReAssign_manual) LinearLayoutCompat ll_manual;
    @BindView(R.id.mTv_GhpLeadsReAssign_selectSingleSalesPerson) MaterialTextView mTv_selectSingleSalesPerson;

    @BindView(R.id.ll_GhpLeadsReAssign_selectedLeads) LinearLayoutCompat ll_selectedLeads;
    @BindView(R.id.flowLayout_GhpLeadsReAssign)
    FlowLayout flowLayout;

    @BindView(R.id.mBtn_GhpLeadsReAssign_submit)
    ...
    private int user_id = 0,sales_person_id=0;
    private String TAG = "SelectedGhpLeadsReAssign_Activity",api_token = "",sales_person_name="";
    private ArrayList<GhpListModel> multiSelect_list;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_selected_ghp_leads_re_assign_);
        ButterKnife.bind(this);
        context= SelectedGhpLeadsReAssign_Activity.this;
    ...
    private void call_postMarksAsUnclaimedLeads()
    {
        ...
        client.getApiService().ghpLeadsTransfer(jsonObject).enqueue(new Callback<JsonObject>()
        {
            @Override
    ...
    private void onSuccessAssignment()
    {
        runOnUiThread(() -> {
            ...
            if (sharedPreferences!=null) {
                editor = sharedPreferences.edit();
                editor.putBoolean("isGhpLeadTransfer", true);
                editor.apply();
            }
