package com.tribeappsoft.leedo.salesPerson.salesHead.claimedList.filter;
...
public class FilterMore_Activity extends AppCompatActivity {
    ...
    private int filterCount_claim =0;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_filter_more_);

        ButterKnife.bind(this);
        context= FilterMore_Activity.this;
            ...
            runOnUiThread(() ->
            {
                ...
                if (sharedPreferences!=null) {
                    ...
                    if (isFilter)
                    {
                        ...
                        filterCount_claim = sharedPreferences.getInt("filterCount_claim", 0);
            ...
            acTv_selectProject.setOnItemClickListener((AdapterView<?> parent, View view, int position, long id) ->
            {
                ...
                for (ProjectModel pojo : itemArrayList)
                {
                    if (pojo.getProject_name().equals(itemName))
                    {
                        ...
                        filterCount_claim = sales_person_id == 0 && (sendFromDate ==null && sendToDate ==null) ? 1 : sales_person_id > 0 && (sendFromDate != null && sendToDate !=null) ? 3 : 2;
                        Log.e(TAG, "setAdapterForProjectName: "+ filterCount_claim);
        ...
        datePickerDialog = new DatePickerDialog(Objects.requireNonNull(context),
                (view, year, monthOfYear, dayOfMonth) -> {
                    ...
                    if(sendFromDate!=null &sendToDate!=null) {
                        ...
                        filterCount_claim = selectedProjectId == -1 && sales_person_id == 0 ? 1 : selectedProjectId >=0  && sales_person_id > 0 ? 3 : 2;
                    }
        ...
        datePickerDialog = new DatePickerDialog(Objects.requireNonNull(context),
                (view, year, monthOfYear, dayOfMonth) -> {
                    ...
                    if(sendFromDate!=null &sendToDate!=null) {
                        ...
                        filterCount_claim = selectedProjectId == -1 && sales_person_id == 0 ? 1 : selectedProjectId >=0  && sales_person_id > 0 ? 3 : 2;
                        Log.e(TAG, "selectVisitPrefToDate: "+ filterCount_claim);
                ...
                acTv__select_SalesPerson.setOnItemClickListener((AdapterView<?> parent, View view, int position, long id) ->
                {
                    ...
                    for (SalesExecutiveModel pojo : salesExecutiveModelArrayList)
                    {
                        if (pojo.getFull_name().equals(itemName))
                        {
                            ...
                            filterCount_claim = selectedProjectId == -1 &&  (sendFromDate ==null && sendToDate ==null) ? 1 : selectedProjectId >= 0 && (sendFromDate != null && sendToDate !=null) ?  3 :  2;

                            Log.e(TAG, "setAdapterSalesPersonsNames: "+ filterCount_claim);
        ...
        if (selectedProjectId==-1  && sales_person_id==0  && sendFromDate ==null && sendToDate ==  null) new Helper().showCustomToast(context, "Please select at least one filter type!");
           ...
           /* if (selectedProjectId!=-1)
            ...
            if (sharedPreferences!=null) {
                ...
                editor.putInt("filterCount_claim", filterCount_claim);
