...
public class ReminderAdapter extends  RecyclerView.Adapter<ReminderAdapter.AdapterViewHolder> {
    ...
    public ReminderAdapter(Activity context, ArrayList<ReminderModel> reminderArrayList, FragmentSalesPersonReminders fragmentSalesPersonReminders) {
        this.context = context;
        this.reminderArrayList = reminderArrayList;
        this.anim = new Animations();
        this.fragmentSalesPersonReminders = fragmentSalesPersonReminders;
    }
