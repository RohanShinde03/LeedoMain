package com.tribeappsoft.leedo.salesPerson.salesHead.callLogStats.filter;
...
public class Filter_SalesHeadCallLogs extends AppCompatActivity {

    @BindView(R.id.cl_filterSalesHeadCalls) CoordinatorLayout parent;
    @BindView(R.id.ll_filterSalesHeadCalls_main) LinearLayoutCompat ll_main;

    @BindView(R.id.acTv_filterSalesHeadCalls_selectProject) AutoCompleteTextView acTv_selectProject;
    @BindView(R.id.tv_filterSalesHeadCalls_select_SalesPerson) AutoCompleteTextView acTv__select_SalesPerson;

    @BindView(R.id.edt_filterSalesHeadCalls_fromDate) TextInputEditText edt_fromDate;
    @BindView(R.id.edt_filterSalesHeadCalls_toDate) TextInputEditText edt_toDate;
    @BindView(R.id.mBtn_filterSalesHeadCalls_clearFilter) MaterialButton mBtn_clearFilter;
    @BindView(R.id.mBtn_filterSalesHeadCalls_applyFilter) MaterialButton mBtn_applyFilter;
    ...
    private int selectedProjectId=-1,sales_person_id=0, mYear, mMonth, mDay;
    private SharedPreferences sharedPreferences;
    private SharedPreferences.Editor editor;
    private String TAG = "Filter_SalesHeadCallLogs",api_token = "", selectedProjectName="", sendFromDate = null, sendToDate = null,selectedSalesPersonsName="";
    private int filterCount_calls=0,user_id=0;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_filter_sales_head_calllogs);

        ButterKnife.bind(this);
        context= Filter_SalesHeadCallLogs.this;
            ...
            acTv_selectProject.setOnItemClickListener((AdapterView<?> parent, View view, int position, long id) ->
            {
                ...
                for (ProjectModel pojo : itemArrayList)
                {
                    if (pojo.getProject_name().equals(itemName))
                    {
                        ...
                        filterCount_calls = sales_person_id == 0 && (sendFromDate ==null && sendToDate ==null) ? 1 : sales_person_id > 0 && (sendFromDate != null && sendToDate !=null) ? 3 : 2;
                        Log.e(TAG, "setAdapterForProjectName: "+filterCount_calls );
        ...
        datePickerDialog = new DatePickerDialog(Objects.requireNonNull(context),
                (view, year, monthOfYear, dayOfMonth) -> {
                    ...
                    if(sendFromDate!=null &sendToDate!=null) {
                        ...
                        //filterCount_calls = selectedProjectId == -1 && sales_person_id == 0 ? 1 : selectedProjectId == -1 && sales_person_id > 0 ? 2 : selectedProjectId >= 0 && sales_person_id > 0 ? 3 : 1;
                        filterCount_calls = selectedProjectId == -1 && sales_person_id == 0 ? 1 : selectedProjectId >=0  && sales_person_id > 0 ? 3 : 2;
                    }
        ...
        datePickerDialog = new DatePickerDialog(Objects.requireNonNull(context),
                (view, year, monthOfYear, dayOfMonth) -> {
                    ...
                    if(sendFromDate!=null &sendToDate!=null) {
                        ...
                        //filterCount_calls = selectedProjectId == -1 && sales_person_id == 0 ? 1 : selectedProjectId >=0  && sales_person_id == 0 ? 2 :  selectedProjectId >= 0 && sales_person_id > 0 ? 3 : 1;

                        filterCount_calls = selectedProjectId == -1 && sales_person_id == 0 ? 1 : selectedProjectId >=0  && sales_person_id > 0 ? 3 : 2;
                        Log.e(TAG, "selectVisitPrefToDate: "+filterCount_calls );
                ...
                acTv__select_SalesPerson.setOnItemClickListener((AdapterView<?> parent, View view, int position, long id) ->
                {
                    ...
                    for (SalesExecutiveModel pojo : salesExecutiveModelArrayList)
                    {
                        if (pojo.getFull_name().equals(itemName))
                        {
                            ...
                            filterCount_calls = selectedProjectId == -1 &&  (sendFromDate ==null && sendToDate ==null) ? 1 : selectedProjectId >= 0 && (sendFromDate != null && sendToDate !=null) ?  3 :  2;

                            Log.e(TAG, "setAdapterSalesPersonsNames: "+filterCount_calls);
    ...
    private void checkValidations()
    {
        ...
        if (selectedProjectId==-1  && sales_person_id==0  && sendFromDate ==null && sendToDate ==  null) new Helper().showCustomToast(context, "Please select at least one filter type!");
           ...
           /* if (selectedProjectId!=-1)
            ...
            //filterCount_calls = selectedProjectId!=-1  && sales_person_id==0  && sendFromDate ==null && sendToDate ==  null
            //filterCount_calls = selectedProjectId == -1 && sendFromDate ==null && sendToDate ==null ? 1 : selectedProjectId >= 0 && sendFromDate == null && sendToDate ==null ? 2 :  sales_person_id > 0 && sendFromDate != null && sendToDate !=null ? 3 : 1;
            ...
            if (sharedPreferences!=null) {
                ...
                editor.putInt("filterCount_calls", filterCount_calls);
