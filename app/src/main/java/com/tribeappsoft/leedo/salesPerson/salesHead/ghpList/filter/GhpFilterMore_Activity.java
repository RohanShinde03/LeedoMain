package com.tribeappsoft.leedo.salesPerson.salesHead.ghpList.filter;
...
public class GhpFilterMore_Activity extends AppCompatActivity {
    ...
    private int filterCount_ghp =0;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_ghp_filter_more_);

        ButterKnife.bind(this);
        context= GhpFilterMore_Activity.this;
            ...
            runOnUiThread(() ->
            {
                ...
                if (sharedPreferences!=null) {
                    ...
                    if (isFilter)
                    {
                        ...
                        filterCount_ghp = sharedPreferences.getInt("filterCount_ghp", 0);
            ...
            acTv_selectProject.setOnItemClickListener((AdapterView<?> parent, View view, int position, long id) ->
            {
                ...
                for (ProjectModel pojo : itemArrayList)
                {
                    if (pojo.getProject_name().equals(itemName))
                    {
                        ...
                        filterCount_ghp = sales_person_id == 0 && (sendFromDate ==null && sendToDate ==null) ? 1 : sales_person_id > 0 && (sendFromDate != null && sendToDate !=null) ? 3 : 2;
                        Log.e(TAG, "setAdapterForProjectName: "+ filterCount_ghp);
        ...
        datePickerDialog = new DatePickerDialog(Objects.requireNonNull(context),
                (view, year, monthOfYear, dayOfMonth) -> {
                    ...
                    if(sendFromDate!=null &sendToDate!=null) {
                        ...
                        filterCount_ghp = selectedProjectId == -1 && sales_person_id == 0 ? 1 : selectedProjectId >=0  && sales_person_id > 0 ? 3 : 2;
                    }
        ...
        datePickerDialog = new DatePickerDialog(Objects.requireNonNull(context),
                (view, year, monthOfYear, dayOfMonth) -> {
                    ...
                    if(sendFromDate!=null &sendToDate!=null) {
                        ...
                        filterCount_ghp = selectedProjectId == -1 && sales_person_id == 0 ? 1 : selectedProjectId >=0  && sales_person_id > 0 ? 3 : 2;
                        Log.e(TAG, "selectVisitPrefToDate: "+ filterCount_ghp);
                ...
                acTv__select_SalesPerson.setOnItemClickListener((AdapterView<?> parent, View view, int position, long id) ->
                {
                    ...
                    for (SalesExecutiveModel pojo : salesExecutiveModelArrayList)
                    {
                        if (pojo.getFull_name().equals(itemName))
                        {
                            ...
                            filterCount_ghp = selectedProjectId == -1 &&  (sendFromDate ==null && sendToDate ==null) ? 1 : selectedProjectId >= 0 && (sendFromDate != null && sendToDate !=null) ?  3 :  2;

                            Log.e(TAG, "setAdapterSalesPersonsNames: "+ filterCount_ghp);
        ...
        if (selectedProjectId==-1  && sales_person_id==0  && sendFromDate ==null && sendToDate ==  null) new Helper().showCustomToast(context, "Please select at least one filter type!");
           ...
           /* if (selectedProjectId!=-1)
            ...
            if (sharedPreferences!=null) {
                ...
                editor.putInt("filterCount_ghp", filterCount_ghp);
