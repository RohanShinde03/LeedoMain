package com.tribeappsoft.leedo.salesPerson.salesHead.ghpList.adapter;
...
import com.tribeappsoft.leedo.salesPerson.salesHead.ghpList.GhpList_Activity;
...
public class GhpListRecyclerAdapter extends RecyclerView.Adapter<GhpListRecyclerAdapter.MyHolder> {
    public GhpList_Activity context;
    public ArrayList<GhpListModel> itemArrayList,multiSelect_list;
    private ArrayList<Integer> leadIdArrayList;
    private final Animations anim;
    private int lastPosition = -1;
    // private int count=0;

    public GhpListRecyclerAdapter(GhpList_Activity context, ArrayList<GhpListModel> modelArrayList, ArrayList<GhpListModel> multiSelect_list) {
    ...
    public void onBindViewHolder(@NonNull MyHolder holder, int position) {
        ...
        final GhpListModel model= itemArrayList.get(position);
