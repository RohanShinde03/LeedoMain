package com.tribeappsoft.leedo.salesPerson.salesHead.ghpList;
...
import com.tribeappsoft.leedo.salesPerson.salesHead.ghpList.adapter.GhpListRecyclerAdapter;
import com.tribeappsoft.leedo.salesPerson.salesHead.ghpList.filter.GhpFilterMore_Activity;
import com.tribeappsoft.leedo.salesPerson.salesHead.ghpList.model.GhpListModel;
...
public class GhpList_Activity extends AppCompatActivity {

    @BindView(R.id.sr_selectGhpList) SwipeRefreshLayout swipeRefresh;
    @BindView(R.id.rv_selectGhpList) RecyclerView recyclerView;
    ...
    //  @BindView(R.id.mBtn_selectGhpList_assign) MaterialButton mBtn_assignLeads;
    @BindView(R.id.ll_selectGhpList_noData) LinearLayoutCompat ll_noData;
    @BindView(R.id.pb_selectGhpList) ContentLoadingProgressBar pb_selectLeads;
    @BindView(R.id.ll_pbLayout) LinearLayoutCompat ll_pb;
    @BindView(R.id.tv_pbLoadingMsg) AppCompatTextView tv_loadingMsg;

    private GhpListRecyclerAdapter recyclerAdapter;
    private ArrayList<GhpListModel> itemArrayList, multiSelect_list,PrevSalesPersonsList;
    private GhpList_Activity context;
    private ArrayList<Integer> leadIdArrayList;
    private ArrayList<Integer> PrevSalesPersonIdArrayList;
    private String TAG = "GhpListList_Activity",api_token="", search_text = "",from_date="",to_date="";
    private int project_id =0,sales_person_id =0,current_page =1,last_page =1,call = 0,filterCount=0, total=0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ghp_list_);
        overridePendingTransition( R.anim.trans_slide_up, R.anim.no_change );
        ButterKnife.bind(this);
        context= GhpList_Activity.this;

        if (getSupportActionBar()!=null) {
            getSupportActionBar().setDisplayOptions(ActionBar.DISPLAY_SHOW_CUSTOM);
            getSupportActionBar().setCustomView(R.layout.layout_ab_center);
            ((AppCompatTextView) getSupportActionBar().getCustomView().findViewById(R.id.tv_abs_title)).setText(getString(R.string.menu_ghp_List));
...
/*                    new Animations().slideOutBottom(mBtn_assignLeads);
    ...
    private void setupRecycleView()
    {
        ...
        recyclerAdapter = new GhpListRecyclerAdapter(context,itemArrayList,multiSelect_list);
    ...
    public void onResume() {
        ...
        if (sharedPreferences!=null) {
            ...
            boolean isGhpLeadTransfer = sharedPreferences.getBoolean("isGhpLeadTransfer", false);
            boolean clearFilter = sharedPreferences.getBoolean("clearFilter", false);
            editor.apply();
            if (isGhpLeadTransfer) {
                ...
                if (sharedPreferences!=null) {
                    editor = sharedPreferences.edit();
                    editor.remove("isGhpLeadTransfer");
                    editor.apply();
                }
            }
            ...
            if(isFilter) {
                ...
                if (sharedPreferences!=null) {
                    ...
                    filterCount = sharedPreferences.getInt("filterCount_ghp", 0);
    ...
    private void call_getAllLeadsBySalesPerson()
    {
        ...
        Observable<Response<JsonObject>> responseObservable = client.getApiService().getGhpReassignLeads(api_token, project_id,sales_person_id, from_date,to_date, limit, call* limit, search_text);
    ...
    {
        GhpListModel model=new GhpListModel();
        ...
        //if (context!= null)
        {
            runOnUiThread(() -> {
                ...
                if (getSupportActionBar()!=null) {
                    ...
                    ((AppCompatTextView) getSupportActionBar().getCustomView().findViewById(R.id.tv_abs_title)).setText(total==0 ? getString(R.string.menu_ghp_List) : getString(R.string.menu_ghp_List) + "(" + total + ")");
                    getSupportActionBar().setHomeAsUpIndicator(R.drawable.ic_close_black_24dp);
                    getSupportActionBar().setDisplayHomeAsUpEnabled(true);
                    getSupportActionBar().setHomeButtonEnabled(true);
                }
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId())
        {
            ...
            case (R.id.action_filter):
                startActivity(new Intent(context, GhpFilterMore_Activity.class));
                break;
        }
        ...
        public boolean onActionItemClicked(ActionMode mode, MenuItem item) {
            switch (item.getItemId())
            {
                ...
                case (R.id.action_proceed):
                    startActivity(new Intent(context, SelectedGhpLeadsReAssign_Activity.class)
