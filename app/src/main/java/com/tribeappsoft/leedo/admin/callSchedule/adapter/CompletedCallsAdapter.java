package com.tribeappsoft.leedo.admin.callSchedule.adapter;
...
public class CompletedCallsAdapter extends RecyclerView.Adapter<CompletedCallsAdapter.MyHolder> {
    ...
    public CompletedCallsAdapter(Activity context, ArrayList<ScheduledCallsModel> modelArrayList, boolean isFromSchedule) {
    ...
    public void onBindViewHolder(@NonNull MyHolder holder, int position) {
      ...
      //  holder.ll_LeadType.setVisibility(model.getLead_types_name() != null && !model.getLead_types_name().trim().isEmpty()? View.VISIBLE :View.GONE);
        ...
        if(model.getSchedule_status_id()==3) {
            holder.tv_ScheduledStatus.setText("Completed");
        }
