package com.tribeappsoft.leedo.admin.Home_Fragment.adapter;
...
import com.tribeappsoft.leedo.admin.Home_Fragment.Fragment_Reminders;
...
public class HomeReminderAdapter extends  RecyclerView.Adapter<HomeReminderAdapter.AdapterViewHolder> {
    ...
    public void onBindViewHolder(@NonNull final AdapterViewHolder holder, final int position) {
        ...
        //holder.tv_reminder_date.setText(myModel.getReminder_date() != null && !myModel.getReminder_date().trim().isEmpty() ? Helper.getNotificationFormatDate(myModel.getReminder_date()) : Helper.getDateTime());
        ...
        holder.tv_lead_AddedBy.setText(myModel.getSales_person_name() != null && !myModel.getSales_person_name().trim().isEmpty() ? myModel.getSales_person_name() : "--");
...
//                    fragmentSalesPersonReminders.delayRefresh();
    ...
    private void onSuccessMarkAsDoneReminder(int position)
    {
        context.runOnUiThread(() -> {
            ...
            fragment_reminders.resetCallGetReminder();
            //fragmentSalesPersonReminders.delayRefresh();
        });
    }
    ...
    static class AdapterViewHolder extends RecyclerView.ViewHolder {
        ...
        @BindView(R.id.ll_lead_addedBy) LinearLayoutCompat ll_lead_addedBy;
        @BindView(R.id.tv_lead_AddedBy) AppCompatTextView tv_lead_AddedBy;
