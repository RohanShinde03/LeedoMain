package com.tribeappsoft.leedo.admin.project_quotations.adapter;
...
import com.tribeappsoft.leedo.admin.project_quotations.AddNewQuotationActivity;
...
public class ProjectQuotationRecyclerAdapter extends RecyclerView.Adapter<ProjectQuotationRecyclerAdapter.AdapterViewHolder> {
    ...
    public ProjectQuotationRecyclerAdapter(Activity activity, ArrayList<EventProjectDocsModel> eventModelArrayList) {
    ...
    public void onBindViewHolder(@NonNull final AdapterViewHolder holder, final int position)
    {
        ...
        File dirFile = new File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS).getPath() + "/Lead_Management/ProjectQuotations/");
...
*/
        ...
        holder.tv_update.setOnClickListener(view -> {
            ...
            context.startActivity(new Intent(context, AddNewQuotationActivity.class)
    ...
    private void showSubmitLeadAlertDialog(int project_brochure_id, int position, AdapterViewHolder holder)
    {
        ...
        tv_msg.setText(context.getString(R.string.delete_project_quotation_question));
        tv_desc.setText(context.getString(R.string.delete_quotation_confirmation));
        ...
        btn_positiveButton.setOnClickListener(view -> {
            ...
            {
                call_deleteProjectQuotation(project_brochure_id, position);
    ...
    private void shareOnEmail(final EventProjectDocsModel mymodel, File dirFile) {
        ...
        final String extra_text = "Project Quotation from Leedo App *"+ title + "*.\t\n\n" + description + "\n\n Ref. Link:- \n" + path;


        if (mymodel!=null) {
            new Helper().openEmailIntent(context,  "Enter Email id here", "Project Quotation from Leedo App", extra_text);
        }
        else new Helper().showCustomToast(context, "Project quotation document might be null or empty!");
    ...
    {
        File dirFile = new File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS).getPath() + "/Lead_Management/Project_Quotations/");
        //StoredPath = DIRECTORY + pic_name + ".png";
        //File file = new File(dirFile, getFileName_from_filePath(path));
...
//          showProgressBar(getString(R.string.opening_your_document));
    ...
    private void showPermissionDialogue(EventProjectDocsModel myModel, String path, File file, boolean flag, ProgressBar pb_donationList, boolean isShare)
    {
        ...
        tv_desc.setText(context.getString(R.string.leedo_needs_requesting_permission_project_quotation_share));
...
//            hideProgressBar();
    ...
    private void call_deleteProjectQuotation(int project_brochure_id, int position)
    {
                ...
                if (response.body() != null) {
                    ...
                    switch (success) {
                        case "1":
                            ...
                            break;
                        case "2":
                            showErrorLog("Error occurred during deleting project Quotation!");
                            break;
                    }
                }
            }
