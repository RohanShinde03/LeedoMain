...
public class StatBookingDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        context = StatBookingDetailsActivity.this;

        if (getSupportActionBar() != null) {
            getSupportActionBar().setTitle(getString(R.string.menu_BookingDetails));
    ...
    private void call_getBookingDetails(){
        ApiClient client = ApiClient.getInstance();
        Observable<Response<JsonObject>> responseObservable = client.getApiService().getStatBookingDetails(api_token,project_id,fromDate,toDate,sales_person_id,cp_executive_id,cp_id,event_id,leadStatusId, sales_team_lead_stats, current_page,filter_text);
        responseObservable.subscribeOn(Schedulers.newThread());
        responseObservable.asObservable();
        responseObservable.doOnNext(jsonObjectResponse -> {
            throw new IllegalStateException("doOnNextException");
    ...
    private void showErrorLog(final String message) {
        if (context != null) {
            context.runOnUiThread(() -> {
                ...
                //hide pb
                swipeRefresh.setRefreshing(false);
                Helper.onErrorSnack(StatBookingDetailsActivity.this, message);
            });
        }
    }
