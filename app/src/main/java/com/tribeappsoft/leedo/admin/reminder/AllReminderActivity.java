...
import com.tribeappsoft.leedo.admin.reminder.adapter.ReminderAdapter;
...
public class AllReminderActivity extends AppCompatActivity {
    ...
    @BindView(R.id.exFab_add_reminder) ExtendedFloatingActionButton exFab_addReminder;
    ...
    private String TAG = "AllReminderActivity",search_text="";
    private ReminderAdapter recyclerAdapter;
    private int userId=0;
    private String api_token="";
    private ArrayList<ReminderModel> itemArrayList = new ArrayList<>();
    private Activity context;
    private int current_page =1, last_page =0,recyclerPosition=0;
    private boolean notifyReminders=false;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sales_person_reminder);
        ButterKnife.bind(this);
        context = AllReminderActivity.this;
        setupUI(parent);
        ...
        if (getSupportActionBar()!=null) {
            ...
            ((AppCompatTextView) getSupportActionBar().getCustomView().findViewById(R.id.tv_abs_title)).setText(getString(R.string.menu_all_reminders));
        ...
        if(getIntent()!=null) {
            notifyReminders = getIntent().getBooleanExtra("notify",false);
        }
        ...
        recyclerView.addOnScrollListener(new MyRecyclerScroll() {
            ...
            public void onHide() {
                //hideViews();
                exFab_addReminder.shrink();
            }

            @Override
            public void onShow() {
                //showViews();
                exFab_addReminder.extend();
            }
            ...
            public void onScrollStateChanged(@NonNull RecyclerView recyclerView, int newState)
            {
                ...
                if (!recyclerView.canScrollVertically(1) && newState==RecyclerView.SCROLL_STATE_IDLE)
                {
                    ...
                    if (!swipeRefresh.isRefreshing())
                    {
                        ...
                        {
                            if (Helper.isNetworkAvailable(AllReminderActivity.this))
                            {
                                //swipeRefresh.setRefreshing(true);
                                showProgressBar();
                                call_getAllReminder();
                            } else Helper.NetworkError(AllReminderActivity.this);
        ...
        exFab_addReminder.setOnClickListener(v -> startActivity(new Intent(context, AddReminderActivity.class)));
        ...
        {
            //show network error
            Helper.NetworkError(AllReminderActivity.this);
            //hide main layouts
    ...
    public void onResume() {
        super.onResume();
        Log.e(TAG, "onResume: AllReminderActivity " );
    ...
    private void setupRecycleView() {
        ...
        recyclerAdapter = new ReminderAdapter(context, itemArrayList);
    ...
    public void resetCallGetReminder()
    {
        ...
        if (recyclerAdapter!=null)
        {
            ...
            if (count == 0) {
                ...
                new Helper().showCustomToast(context, "Please wait. Loading next reminders...");
    ...
    private void call_getAllReminder()
    {
        ...
        Observable<Response<JsonObject>> responseObservable = client.getApiService().Get_AllReminder(api_token,userId,current_page,search_text);
    ...
    {
        AllReminderActivity.this.runOnUiThread(() -> {
    ...
    private void showErrorLog(final String message)
    {
        context.runOnUiThread(() -> {
            ...
            Helper.onErrorSnack(AllReminderActivity.this,message);
            recyclerView.setVisibility(View.GONE);
            ll_noDataFound.setVisibility(View.VISIBLE);
        });
    }
            ...
            public void onResponse(@NonNull Call<JsonObject> call, @NonNull Response<JsonObject> response) {
                if (response.body() != null) {
                    ...
                    switch (success) {
                        case "1":
                            markAsDoneReminder();
                            new Helper().showCustomToast(AllReminderActivity.this,"Mark as done Successfully");
                            break;
                        case "2":
    ...
    private void setupUI(View view) {
        ...
        if (!(view instanceof TextInputEditText)) {
            view.setOnTouchListener((v, event) -> {
                Helper.hideSoftKeyboard(AllReminderActivity.this, view);
                return false;
            });
        }
