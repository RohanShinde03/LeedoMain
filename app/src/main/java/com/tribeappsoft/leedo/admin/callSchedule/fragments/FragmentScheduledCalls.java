...
public class FragmentScheduledCalls extends Fragment //implements CallScheduleMainActivity.onTabChangeInterface
{
    ...
    @BindView(R.id.ll_ScheduledCalls_search) LinearLayoutCompat ll_searchBar;
    @BindView(R.id.edt_ScheduledCalls_search) TextInputEditText edt_search;
    @BindView(R.id.iv_ScheduledCalls_clearSearch) AppCompatImageView iv_clearSearch;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Log.e(TAG, "onCreate: FragmentScheduledCalls");
        instance=this;
        setHasOptionsMenu(true);
    }

    public static FragmentScheduledCalls getInstance(){
        return instance;
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.fragment_scheduled_calls, container, false);
    ...
    public void onResume() {
        ...
        if (sharedPreferences!=null) {
            ...
            if (sharedPreferences.getBoolean("isFilter", false)) {
                ...
                ((CallScheduleMainActivity) Objects.requireNonNull(requireActivity())).onSetTabsViewPager(getCurDate(),0, 0, 0, false);
    ...
    private void onSuccessSetCount(String serviceDate) {
        ...
        if(getActivity() != null){
            getActivity().runOnUiThread(() ->{
                ...
                swipeRefresh.setRefreshing(false);
                ((CallScheduleMainActivity) Objects.requireNonNull(requireActivity())).onSetTabsViewPager(serviceDate,scheduledCount, completedCount, 0, true);
