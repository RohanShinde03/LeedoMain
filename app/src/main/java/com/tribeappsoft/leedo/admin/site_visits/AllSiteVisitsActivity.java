...
public class AllSiteVisitsActivity extends AppCompatActivity {

    private String TAG="AllSiteVisitsActivity";
    ...
    @BindView(R.id.nsv_allSiteVisit) StickyScrollView nsv;
    ...
    @BindView(R.id.exFab_allSiteVisit_addSiteVisit) ExtendedFloatingActionButton exFab_addSiteVisit;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_all_site_visits);

        ButterKnife.bind(this);

        context= AllSiteVisitsActivity.this;
        ...
        if (getSupportActionBar()!=null)
        {
            ...
            ((AppCompatTextView) getSupportActionBar().getCustomView().findViewById(R.id.tv_abs_title)).setText(getString(R.string.all_site_visit));
    ...
    private void init()
    {
     ...
     /*   Bundle bundle = this.getArguments();
        ...
        if (openFlag ==0)
        {
            ...
            if (sharedPreferences.getString("jA_allSiteVisits", null) != null) jA_feeds = sharedPreferences.getString("jA_allSiteVisits", null);
            if (jA_feeds!=null) {
        ...
        exFab_addSiteVisit.setOnClickListener(v -> {
        ...
        if (jsonObject.has("data")) {
            if (!jsonObject.get("data").isJsonNull() && jsonObject.get("data").isJsonArray()) {
                ...
                if (call==1)
                {
                    ...
                    if (sharedPreferences!=null) {
                        editor = sharedPreferences.edit();
                        editor.putString("jA_allSiteVisits", jsonArray.toString());
                        editor.apply();
                    }
                }
...
*/
                ...
                case R.id.menu_updateLead_updateLead:
                    startActivity(new Intent(AllSiteVisitsActivity.this, AddNewLeadActivity.class)
