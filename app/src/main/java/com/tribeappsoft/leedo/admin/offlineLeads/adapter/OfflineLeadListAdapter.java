...
public class OfflineLeadListAdapter extends RecyclerView.Adapter<OfflineLeadListAdapter.MyHolder>{
    ...
    public OfflineLeadListAdapter(Activity context, ArrayList<OfflineLeadModel> projectModelArrayList) {
    ...
    public MyHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_layout_offline_leads, parent,false);
    ...
    public void onBindViewHolder(@NonNull MyHolder holder, int position) {
       ...
       // int user_id = sharedPreferences.getInt("user_id", 0);
        ...
        /*if(model.getCustomer_project_name() != null && !model.getCustomer_project_name().trim().isEmpty())
        {
            holder.tv_ProjectName.setText((model.getCustomer_unit_type() != null && !model.getCustomer_unit_type().trim().isEmpty())  ? model.getCustomer_unit_type():"-");
        }else if(model.getCustomer_unit_type() != null && !model.getCustomer_unit_type().trim().isEmpty())
        {
            holder.tv_ProjectName.setText((model.getCustomer_unit_type() != null && !model.getCustomer_unit_type().trim().isEmpty())  ? model.getCustomer_project_name()+" | "+model.getCustomer_unit_type():"-");
        }else {
            holder.tv_ProjectName.setVisibility(View.GONE);
        }*/
        ...
        //holder.tv_ProjectName.setVisibility((model.getCustomer_project_name() != null && !model.getCustomer_project_name().trim().isEmpty() && model.getCustomer_unit_type() != null && !model.getCustomer_unit_type().trim().isEmpty()? View.VISIBLE :View.GONE));
        ...
        holder.mTv_DateOfBirth.setText(model.getDob() != null && !model.getDob().trim().isEmpty()?  formatEventDate(model.getDob()) :"-");
       ...
       /* holder.iv_homeFeed_ownLeadCall.setOnClickListener(v -> {
            if (model.getMobile_number()!=null) {
                new Helper().openPhoneDialer(context, model.getMobile_number().trim());
