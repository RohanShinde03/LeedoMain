...
public class Fragment_SiteVisits extends Fragment //implements CallScheduleMainActivity.onTabChangeInterface
{


    private String TAG="Fragment_SiteVisits";
    ...
    private int openFlag = 0,user_id = 0,call = 0, lastPosition = -1, claimPosition =0,claimAPiCount =0,project_id = 0,sales_person_id = 0, lead_count = 0, site_visit_count = 0,call_schedule_count = 0,reminder_count = 0,
            lead_id =0, skip_count =0, call_lead_id =0, call_lead_status_id =0; //tabAt=0
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Log.e(TAG, "onCreate: Fragment_SiteVisits");
        instance=this;
        setHasOptionsMenu(true);
    }

    public static Fragment_SiteVisits getInstance(){
        return instance;
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        //requireActivity().setTitle(R.string.vendors);
    }


    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.fragment_home_sitevisits, container, false);
    ...
    private void init()
    {
     ...
     /*   Bundle bundle = this.getArguments();
        ...
        if (Helper.isNetworkAvailable(requireActivity())) getLeadData();

        if (openFlag ==0)
        {
            //set cached feed only for WO filtered data
            String jA_feeds = null;
            if (sharedPreferences.getString("jA_feeds_sitevisits", null) != null) jA_feeds = sharedPreferences.getString("jA_feeds_sitevisits", null);
            if (jA_feeds!=null) {
       ...
       /* //voice input
        iv_VoiceSearch.setOnClickListener(view -> {
            //hide keyboard
            hideSoftKeyboard(requireActivity(), requireActivity().getWindow().getDecorView().getRootView());
...
/*
    ...
    private String getFilterJson()
    {
        ...
        jsonObject.addProperty("lead_status_id", 2);
...
//                new Helper().showCustomToast(requireActivity(), "Bottom");
//            }
    ...
    public void onResume() {
        ...
        if (sharedPreferences!=null) {
            editor = sharedPreferences.edit();
            isLeadAdd = sharedPreferences.getInt("isSiteVisitAdd",0);
        ...
        if(isLeadUpdate == 1)
        {
            ...
            if (Helper.isNetworkAvailable(this.requireActivity())) {
            ...
            else Helper.NetworkError(this.requireActivity());
       ...
       /*     new Animations().slideInLeft(iv_clearSearch);
        ...
        //if (broadcastReceiver!=null) requireActivity().registerReceiver(broadcastReceiver, new IntentFilter(FireBaseMessageService.BROADCAST_ACTION));
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == REQ_CODE_SPEECH_INPUT) {
            if (resultCode == RESULT_OK && null != data) {
                ...
                Helper.hideSoftKeyboard(requireActivity(), requireActivity().getWindow().getDecorView().getRootView());
            }
        }
    }
...
*/
    ...
    {
        if (Helper.isNetworkAvailableContext(getApplicationContext()))
        {
            //clear editText
            // edt_search.setText("");
            //gone visibility
...
*/
   ...
   /* private void searchFeedApi()
    ...
    private void call_getSalesFeed() {
        ...
        Observable<Response<JsonObject>> responseObservable = client.getApiService().getHomeSiteVisits(api_token, sales_person_id,project_id, limit, call * limit, filter_text, other_ids, last_lead_updated_at,todo_date,startDate,endDate);
        responseObservable.asObservable();
        responseObservable.doOnNext(jsonObjectResponse -> {
            throw new IllegalStateException("doOnNextException");
        });
        ...
        if (jsonObject.has("data")) {
            if (!jsonObject.get("data").isJsonNull() && jsonObject.get("data").isJsonArray()) {
                ...
                if (call==1)
                {
                    ...
                    if (sharedPreferences!=null) {
                        editor = sharedPreferences.edit();
                        editor.putString("jA_feeds_sitevisits", jsonArray.toString());
                        editor.apply();
                    }
                }
    ...
    private void setFeeds() {
        ...
        requireActivity().runOnUiThread(() -> {
            ...
            /*if (sharedPreferences!=null)
            {
                ...
                {
                    //if (isNetworkAvailable(Objects.requireNonNull(requireActivity()))) call_getUnClaimedLeads();
                    //else NetworkError(requireActivity());
    ...
    private View getFeedsView(int position) {
        ...
        iv_own_Lead_call.setOnClickListener(v -> {
            if (myModel.getCall()!=null) {
                ...
                //new Helper().openPhoneDialer(Objects.requireNonNull(requireActivity()), myModel.getCall());
        ...
        iv_ownLeadGmail.setOnClickListener(v -> {
            ...
            else new Helper().showCustomToast(requireActivity(), "Customer Mobile Email not added!");
        });
        ...
        ll_own_view.setVisibility(View.VISIBLE);
         ...
         /*else if (myModel.getFeed_type_id() == 2) {
            ...
            iv_others_Lead_call.setOnClickListener(v -> {
                ...
                }else new Helper().showCustomToast(requireActivity(), "Customer number not found!");
            });
    ...
    private void showPopUpMenu(View view, FeedsModel myModel, int position) {
        ...
        switch (myModel.getLead_status_id())
        {
            ...
            default:    //def
                ...
                popupMenu.getMenu().findItem(R.id.menu_leadOption_addCallLog).setVisible(true);
                popupMenu.getMenu().findItem(R.id.menu_updateLead_updateLeadName).setVisible(false);
                popupMenu.getMenu().findItem(R.id.menu_updateLead_updateLead).setVisible(false);
                popupMenu.getMenu().findItem(R.id.menu_updateLead_updateLeadStage).setVisible(true);
                popupMenu.getMenu().findItem(R.id.menu_leadOption_addSiteVisit).setVisible(true);
                break;
        }
        ...
        popupMenu.setOnMenuItemClickListener(item -> {
            ...
            switch (item.getItemId())
            {
                ...
                case R.id.menu_leadOption_addCallLog:
                    if (myModel.getCuidModel()!=null)
                    {
                        requireActivity().startActivity(new Intent(requireActivity(), CallLogActivity.class)
                                .putExtra("cuidModel", myModel.getCuidModel())
                ...
                case R.id.menu_leadOption_addCallSchedule:
                    if (myModel.getCuidModel()!=null)
                    {
                        requireActivity().startActivity(new Intent(requireActivity(), AddCallScheduleActivity.class)
...
*/
    ...
    private void prepareToMakePhoneCall() {
        ...
        //Objects.requireNonNull(requireActivity()).startService(new Intent(requireActivity(), TelephonyCallService.class));

       /* if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
            //new MediaProjectionManager(requireActivity()).createScreenCaptureIntent();
            MediaProjectionManager projectionManager = new MediaProjectionManager(requireActivity());
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            requireActivity().startForegroundService(new Intent(requireActivity(), TelephonyCallService.class)
            ...
            //start the service first
            requireActivity().startService(new Intent(requireActivity(), TelephonyCallService.class)
                    .putExtra("call_lead_id",call_lead_id)
                    .putExtra("lead_status_id",call_lead_status_id)
                    .putExtra("call_schedule_id",0)
                    .putExtra("user_id",user_id)
       ...
       /* //update into sharedPref
        ...
        new Helper().showSuccessCustomToast(requireActivity(), "Calling from Leedo App...!");

        new Handler().postDelayed(() -> {
            //make a call
            new Helper().makePhoneCall(requireActivity(), customer_mobile);
        }, 1500);
    ...
    private void showAddSiteVisitAlert(String CustomerName, FeedsModel myModel)
    {
        ...
        btn_negativeButton.setOnClickListener(view -> {
            ...
            //go to generate GHP
            requireActivity().startActivity(new Intent(requireActivity(), GenerateTokenActivity.class)
                    .putExtra("fromOther",2)
                    .putExtra("cuidModel", myModel.getCuidModel())
                    .putExtra("cu_id", myModel.getSmall_header_title())
                    .putExtra("lead_name", myModel.getMain_title())
    ...
    private void call_cancelAllotment(int bookings_id)
    {
        ...
        client.getApiService().cancelAllotment(jsonObject).enqueue(new Callback<JsonObject>()
        {
            ...
            public void onResponse(@NonNull Call<JsonObject> call, @NonNull Response<JsonObject> response)
            {
                ...
                else
                {
                    ...
                    switch (response.code()) {
                        case 404:
                            showErrorLogClaimLead(requireActivity().getString(R.string.something_went_wrong_try_again));
                            break;
                        case 500:
                            showErrorLogClaimLead(requireActivity().getString(R.string.server_error_msg));
                            break;
                        default:
                            showErrorLogClaimLead(requireActivity().getString(R.string.unknown_error_try_again) + " "+response.code());
                            break;
                    }
                }
            ...
            {
                Log.e(TAG, "onError: " + e.toString());
                if (e instanceof SocketTimeoutException) showErrorLogClaimLead(requireActivity().getString(R.string.connection_time_out));
                else if (e instanceof IOException) showErrorLogClaimLead(requireActivity().getString(R.string.weak_connection));
    ...
    private void showEditNameDialog(CUIDModel model, int position, String ownOrOther)
    {
        ...
        ArrayAdapter<String> adapter = new ArrayAdapter<>(requireActivity(), R.layout.layout_spinner_item, namePrefixArrayList);
        //set def selected
        acTv_prefix_mrs.setText(model.getPrefix());
        ...
        btn_positiveButton.setOnClickListener(view -> {
            ...
            if(edt_editLeadName.getText().toString().trim().isEmpty()) {
                ...
                new Helper().showCustomToast(requireActivity(), "Please enter first name!");
        ...
        //alertDialog.getWindow().setSoftInputMode(WindowManager.LayoutParams.SOFT_INPUT_STATE_VISIBLE);
        //alertDialog.getWindow().setSoftInputMode(WindowManager.LayoutParams.SOFT_INPUT_STATE_VISIBLE);
        alertDialog.getWindow().setBackgroundDrawable(requireActivity().getResources().getDrawable(R.drawable.bg_claim_popup));
        //alertDialog.getWindow().setLayout(pixel-10, wmlp.height );
        alertDialog.getWindow().setAttributes(wmlp);
    }
    ...
    private void showUpdateLeadStageAlert(FeedsModel myModel, int pos)
    {
        ...
        if (leadStagesModelArrayList.size() >0 &&  leadStageStringArrayList.size()>0)
        {
            ...
            //ArrayAdapter<String> adapter = new ArrayAdapter<>(requireActivity(),R.layout.layout_spinner_item, leadStageStringArrayList);
            // acTv_leadStage.setAdapter(adapter);
            //acTv_leadStage.setThreshold(0);
            //acTv_leadStage.setTypeface(FontAwesomeManager.getTypeface(requireActivity(), FontAwesomeManager.FONTAWESOME));
            ...
            adapter = new CustomerAdapter(requireActivity(), leadStagesModelArrayList);
            acTv_leadStage.setAdapter(adapter);
    ...
    private void showSuccessUpdateLeadStage(int position, String selectedLeadStageName, int lead_stage_id) {
        ...
        requireActivity().runOnUiThread(() -> {
            ...
            textView_dot.setTypeface(FontAwesomeManager.getTypeface(requireActivity(), FontAwesomeManager.FONTAWESOME));
            ll_leadStage_dot.setVisibility(lead_stage_id==0?View.GONE :View.VISIBLE);

            switch (lead_stage_id) {
                case 1:
                    textView.setTextColor(requireActivity().getResources().getColor(R.color.colorhot));
                    textView_dot.setTextColor(requireActivity().getResources().getColor(R.color.colorhot));
                    break;
                case 2:
                    textView.setTextColor(requireActivity().getResources().getColor(R.color.colorwarm));
                    textView_dot.setTextColor(requireActivity().getResources().getColor(R.color.colorwarm));
                    break;
                case 3:
                    textView.setTextColor(requireActivity().getResources().getColor(R.color.colorcold));
                    textView_dot.setTextColor(requireActivity().getResources().getColor(R.color.colorcold));
                    break;
                case 4:
                    textView.setTextColor(requireActivity().getResources().getColor(R.color.colorni));
                    textView_dot.setTextColor(requireActivity().getResources().getColor(R.color.colorni));
                case 5:
                    textView.setTextColor(requireActivity().getResources().getColor(R.color.color_lead_mismatch));
                    textView_dot.setTextColor(requireActivity().getResources().getColor(R.color.color_lead_mismatch));
                    break;
                default:
                    textView.setTextColor(requireActivity().getResources().getColor(R.color.BlackLight));
                    textView_dot.setTextColor(requireActivity().getResources().getColor(R.color.BlackLight));
            }

            //show success toast
            new Helper().showSuccessCustomToast(requireActivity(),"Lead stage updated successfully!");
        });
    }
    ...
    private void showSuccessAlert()
    {
        requireActivity().runOnUiThread(() -> {
            ...
            //hide
            hideCancellationProgressBar();
            //  onErrorSnack(requireActivity(), "Flat released successfully!");
    ...
    private void showSuccessReleaseFlatAlert()
    {
        requireActivity().runOnUiThread(() -> {
            ...
            //show toast
            new Helper().showSuccessCustomToast(requireActivity(), requireActivity().getString(R.string.flat_released_successfully));
    ...
    {
        //Vibrator v = (Vibrator) requireActivity().getSystemService(requireActivity().VIBRATOR_SERVICE);
       /* if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            assert v != null;
        ...
        if (requireActivity()!=null)
        {
            claimDialog = new Dialog(requireActivity());
            claimDialog.setCancelable(true);
            Drawable button = getResources().getDrawable(R.drawable.claim_button_drawable, requireActivity().getTheme());
            @SuppressLint("InflateParams") View view  = requireActivity().getLayoutInflater().inflate(R.layout.layout_claim_now_pop_up, null);
    ...
    private void showSuccessPopup(boolean fromFeed, int position)
    {
        ...
        Dialog claimSuccessDialog = new Dialog(requireActivity());
        claimSuccessDialog.setCancelable(true);
        View view  = requireActivity().getLayoutInflater().inflate(R.layout.layout_claim_now_success, null);
        ...
        new Handler(getMainLooper()).postDelayed(() -> {
            ...
            if (fromFeed)
            {
               ...
               /* LinearLayoutCompat ll_homeFeed_othersCard = ll_addFeedData.getChildAt(position).findViewById(R.id.ll_homeFeed_othersCard);
                ...
                tv_others_Lead_status.setBackgroundColor(requireActivity().getResources().getColor(R.color.color_lead_claimed));*/
    ...
    private void expandSubView(final View v) {
        ...
        //a.setDuration((int)(targetHeight / v.getrequireActivity()().getResources().getDisplayMetrics().density));
        a.setDuration(100);
    ...
    private void showProgressBar() {
        //hideSoftKeyboard(requireActivity(), getWindow().getDecorView().getRootView());
        ll_loadingContent.setVisibility(View.VISIBLE);
        // Objects.requireNonNull(requireActivity()).getWindow().setFlags(WindowManager.LayoutParams.FLAG_NOT_TOUCHABLE, WindowManager.LayoutParams.FLAG_NOT_TOUCHABLE);
    }

    private void hideProgressBar() {
        ll_loadingContent.setVisibility(View.GONE);
        //Objects.requireNonNull(requireActivity()).getWindow().clearFlags(WindowManager.LayoutParams.FLAG_NOT_TOUCHABLE);
    }
    ...
    public void setupUI(View view) {
        ...
        if (!(view instanceof TextInputEditText)) {
            view.setOnTouchListener((v, event) -> {
                Helper.hideSoftKeyboard(requireActivity(), view);
                return false;
            });
        }
    ...
    public void onPause()
    {
        super.onPause();
        Log.e(TAG, "onPause: ");
        //if (broadcastReceiver!=null) requireActivity().unregisterReceiver(broadcastReceiver);
    }
    ...
    private void doOnBackPressed() {
        ...
        new Helper().showCustomToast(requireActivity(), getResources().getString(R.string.app_exit_msg));
    ...
    private void onSuccessSetCount() {
        if(requireActivity() != null){
            requireActivity().runOnUiThread(() ->{
                ...
                swipeRefresh.setRefreshing(false);
                FragmentHome.getInstance().onSetTabsViewPager(call_schedule_count, site_visit_count,lead_count, reminder_count,1, true,false);
    ...
    public void onCreateOptionsMenu(@NonNull Menu menu, @NonNull MenuInflater inflater) {
        ...
        if (searchItem != null) {
            ...
            searchView.setQueryHint(getString(R.string.search_site_visits));
