package com.tribeappsoft.leedo.admin.reports.callLogStats.detailedStatsList;
...
import com.tribeappsoft.leedo.admin.reports.callLogStats.adapter.FilterCompletedCallsAdapter;
...
public class FilterCallCompletedDetailsActivity extends AppCompatActivity {
    ...
    private String TAG = "FilterCallStatsDetailsActivity";
    private String api_token="", filter_text = "",from_date="",to_date="";
    private ArrayList<ScheduledCallsModel> itemArrayList;
    private FilterCompletedCallsAdapter recyclerAdapter;
    ...
    public FilterCallCompletedDetailsActivity() {
    }

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_filter_completed_call_stats);
        ButterKnife.bind(this);
        context = FilterCallCompletedDetailsActivity.this;

        if (getSupportActionBar() != null) {

            getSupportActionBar().setTitle(getString(R.string.completed_calls));
    ...
    private void init()
    {
       ...
       // boolean isSalesTeamLead = sharedPreferences.getBoolean("isSalesTeamLead", false);
        ...
        if(getIntent()!=null)
        {
            ...
            //int schedule_status_id = getIntent().getIntExtra("schedule_status_id", 0);
            ...
            filterCountText.setText(String.format(Locale.getDefault(), "%d%s", filterCount, getString(R.string.filter_applied)));
...
*//*
    ...
    private void setupRecycleView() {
        ...
        recyclerAdapter= new FilterCompletedCallsAdapter(context, itemArrayList, true);
    ...
    private void call_getAllCompletedCalls()
    {
        ApiClient client = ApiClient.getInstance();
        Observable<Response<JsonObject>> responseObservable = client.getApiService().getFilterCompletedCallLeads(api_token, sales_person_id, "",from_date,to_date, current_page, project_id,filter_text, sales_team_lead_stats);
    ...
    private void setJson(JsonObject jsonObject) {
        ...
        if (jsonObject.has("schedule_updated_at")) model.setCreated_at(!jsonObject.get("schedule_updated_at").isJsonNull() ? jsonObject.get("schedule_updated_at").getAsString() : Helper.getDateTime() );
    ...
    private void setupUI(View view) {
        ...
        if (!(view instanceof TextInputEditText)) {
            view.setOnTouchListener((v, event) -> {
                Helper.hideSoftKeyboard(Objects.requireNonNull(context), view);
                return false;
            });
        }
