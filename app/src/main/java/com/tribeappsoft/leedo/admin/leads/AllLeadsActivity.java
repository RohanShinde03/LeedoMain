...
public class AllLeadsActivity extends AppCompatActivity {
    ...
    private String TAG="AllLeadsActivity";
    ...
    @BindView(R.id.nsv_fragSalesPersonHomeFeed) StickyScrollView nsv;
    ...
    @BindView(R.id.edt_FragmentHomeFeed_search) AppCompatEditText edt_search;
    ...
    private void init()
    {
     ...
     /*   Bundle bundle = this.getArguments();
        ...
        if (openFlag ==0)
        {
            ...
            if (sharedPreferences.getString("jA_allLeads", null) != null) jA_feeds = sharedPreferences.getString("jA_allLeads", null);
            if (jA_feeds!=null) {
        ...
        if (jsonObject.has("data")) {
            if (!jsonObject.get("data").isJsonNull() && jsonObject.get("data").isJsonArray()) {
                ...
                if (call==1)
                {
                    ...
                    if (sharedPreferences!=null) {
                        editor = sharedPreferences.edit();
                        editor.putString("jA_allLeads", jsonArray.toString());
                        editor.apply();
                    }
                }
