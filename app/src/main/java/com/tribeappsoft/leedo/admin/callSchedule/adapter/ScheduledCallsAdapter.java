...
public class ScheduledCallsAdapter extends RecyclerView.Adapter<ScheduledCallsAdapter.MyHolder> {
    private static final String TAG ="ScheduledCallsAdapter" ;
    ...
    public void onBindViewHolder(@NonNull MyHolder holder, int position) {
        ...
        if(model.getCall_schedule_date()!=null && model.getCall_schedule_time()!=null){
            if(!model.getCall_schedule_date().trim().isEmpty()){
                holder.tv_ScheduledOnDate.setText(Helper.formatDateFromString(model.getCall_schedule_date())+" at "+model.getCall_schedule_time());
            }else{ holder.tv_ScheduledOnDate.setText(model.getScheduled_on() != null && !model.getScheduled_on().trim().isEmpty()? model.getScheduled_on(): "--"); }
        }else{ holder.tv_ScheduledOnDate.setText(model.getScheduled_on() != null && !model.getScheduled_on().trim().isEmpty()? model.getScheduled_on(): "--"); }
        ...
        holder.mBtn_reschedule.setOnClickListener(view -> {
            ...
            intent.putExtra("lead_cu_id", model.getMobile_number());
