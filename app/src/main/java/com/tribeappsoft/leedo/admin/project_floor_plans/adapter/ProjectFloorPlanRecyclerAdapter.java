package com.tribeappsoft.leedo.admin.project_floor_plans.adapter;
...
import com.tribeappsoft.leedo.admin.project_floor_plans.AddNewFloorPlanActivity;
...
public class ProjectFloorPlanRecyclerAdapter extends RecyclerView.Adapter<ProjectFloorPlanRecyclerAdapter.AdapterViewHolder> {
    ...
    public ProjectFloorPlanRecyclerAdapter(Activity activity, ArrayList<EventProjectDocsModel> eventModelArrayList) {
    ...
    public void onBindViewHolder(@NonNull final AdapterViewHolder holder, final int position)
    {
        ...
        holder.tv_projectName.setText(myModel.getProjectName() != null && !myModel.getProjectName().trim().isEmpty()? myModel.getProjectName():"--");
        ...
        File dirFile = new File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS).getPath() + "/Lead_Management/ProjectFloorPlans/");
...
*/
        ...
        holder.tv_update.setOnClickListener(view -> {
            ...
            context.startActivity(new Intent(context, AddNewFloorPlanActivity.class)
    ...
    static class AdapterViewHolder extends RecyclerView.ViewHolder
    {
        ...
        @BindView(R.id.tv_itemProjectDocs_projectName) AppCompatTextView tv_projectName;
    ...
    private void showSubmitLeadAlertDialog(int project_brochure_id, int position, AdapterViewHolder holder)
    {
        ...
        tv_msg.setText(context.getString(R.string.delete_project_floor_plan_question));
        tv_desc.setText(context.getString(R.string.delete_floor_plan_confirmation));
        ...
        btn_positiveButton.setOnClickListener(view -> {
            ...
            {
                call_deleteProjectFloorPlan(project_brochure_id, position);
    ...
    private void shareOnEmail(final EventProjectDocsModel mymodel, File dirFile) {
        ...
        final String extra_text = "Project Floor Plan from Leedo App *"+ title + "*.\t\n\n" + description + "\n\n Ref. Link:- \n" + path;


        if (mymodel!=null) {
            new Helper().openEmailIntent(context,  "Enter Email id here", "Project Floor Plan from Leedo App", extra_text);
        }
        else new Helper().showCustomToast(context, "Project Floor Plan document might be null or empty!");
    ...
    {
        File dirFile = new File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS).getPath() + "/Lead_Management/Project_FloorPlans/");
        //StoredPath = DIRECTORY + pic_name + ".png";
        //File file = new File(dirFile, getFileName_from_filePath(path));
...
//          showProgressBar(getString(R.string.opening_your_document));
    ...
    private void showPermissionDialogue(EventProjectDocsModel myModel, String path, File file, boolean flag, ProgressBar pb_donationList, boolean isShare)
    {
        ...
        tv_desc.setText(context.getString(R.string.leedo_needs_requesting_permission_project_floor_plan_share));
...
//            hideProgressBar();
    ...
    private void call_deleteProjectFloorPlan(int project_brochure_id, int position)
    {
                ...
                if (response.body() != null) {
                    ...
                    switch (success) {
                        case "1":
                            ...
                            break;
                        case "2":
                            showErrorLog("Error occurred during deleting project Floor Plan!");
                            break;
                    }
                }
            }
