...
public class CountryCodePicker extends RelativeLayout {
  ...
  private void init(AttributeSet attrs) {
    inflate(getContext(), R.layout.ccp_layout_code_picker, this);
    ...
    mCountryCodeHolderClickListener = v -> {
      if (isClickable())
      {
          //TODO Commented due to customized
  ...
  private void applyCustomPropertyOfColor(TypedArray arr) {
    ...
    if (isInEditMode()) {
      ...
      textColor = arr.getColor(R.styleable.CountryCodePicker_ccp_textColor,
          getColor(getContext(), R.color.main_black));
    }
   ...
   */
  @SuppressWarnings("unused")
  public void registerPhoneNumberTextView(AppCompatTextView textView) {
    setRegisteredPhoneNumberTextView(textView);
    if (mIsHintEnabled) setPhoneNumberHint();
  }

  @SuppressWarnings("unused") public AppCompatTextView getRegisteredPhoneNumberTextView() {
    return mRegisteredPhoneNumberTextView;
  }

  void setRegisteredPhoneNumberTextView(AppCompatTextView phoneNumberTextView) {
  ...
  private void setPhoneNumberWatcherToTextView(AppCompatTextView textView, String countryNameCode) {
    if (mIsEnablePhoneNumberWatcher) {
      if (mPhoneNumberWatcher == null) {
